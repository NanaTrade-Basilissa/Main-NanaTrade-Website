...
export function Philosophy() {
  return (
    <section id="philosophy" className="bg-basilissa-yellow text-ink py-28 sm:py-32 lg:py-40">
      <Container>
        <Reveal>
          <h2 className="max-w-3xl text-4xl sm:text-5xl lg:text-6xl font-semibold tracking-tight leading-[1.08] text-balance">
            Our philosophy shapes everything we do.
          </h2>
        </Reveal>
